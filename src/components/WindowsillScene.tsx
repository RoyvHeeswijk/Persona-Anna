...
const items: StillLifeItem[] = [
  ...
  {
    id: "werkpas",
    title: "De Barcode-Identiteit",
    body: "In de klinische stilte van de toiletcabine staart ze naar haar eigen naam op dit plastic pasje. Hier 'steelt' ze elke dag twee minuten van de tikkende klok. Terwijl ze haar vinger over de barcode laat gaan, beseft ze dat dit haar hele identiteit in Nederland is: een personeelsnummer dat moet blijven presteren om haar bed te mogen houden.",
    imageSrc: "/objects/werkpas.png",
    top: "52%",
    left: "72%",
    width: 200,
    height: 150,
